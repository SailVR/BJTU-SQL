...
function reg($username,$email,$pwd,$pass,$transfer,$port,$invite_num,$money){
    global $dbc;
    $sql1 ="INSERT INTO `user` (`uid`, `user_name`, `email`, `pass`, `passwd`, `t`, `u`, `d`, `plan`,
	`transfer_enable`, `port`, `switch`, `enable`, `type`, `reg_date`,`invite_num`,`money`)
           VALUES (NULL, '$username', '$email', '$pwd', '$pass', '0', '0', '0', 'A', '$transfer', '$port', '1',
		   '1', '7', now(),$invite_num,$money)";
    $sql2 ="INSERT INTO `radcheck` (`id`,`username`, `attribute`, `op`, `value`)
           VALUES (NULL, '$username', 'Cleartext-Password', ':=', '$pass')";
